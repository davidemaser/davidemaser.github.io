...
var core = {
    ...
    planBify:function(){
        $('.objHeroPromote').find('option[value="true"]').prop('selected',true).parent().prop('disabled',true);
        $('.objHeroSticky').find('option[value="false"]').prop('selected',true).parent().prop('disabled',true);
